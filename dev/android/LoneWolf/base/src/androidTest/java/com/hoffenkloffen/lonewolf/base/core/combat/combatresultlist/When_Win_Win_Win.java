...
public class When_Win_Win_Win extends Given_CombatResultList_with_3_enemies {
    ...
    @Test
    public void then_the_outcome_should_be_Win() {
        assertEquals(Outcome.Win, list.getOutcome());
    }
}
