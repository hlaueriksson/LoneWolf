...
import com.hoffenkloffen.lonewolf.controllers.section.rules.CombatsAreWon;
...
public class Given_CombatsAreWon extends Given_SectionRule {

    protected void given() {
        rule = new CombatsAreWon();
    }
